...
% % Top plot
% ax1 = nexttile;
% plot(ax1,x_nodes_biga(:,1),u(3:3:end));
% title(ax1,'Rotación por torsión perfil cerrado');
% grid(ax1,'on');
% 
% % Bottom plot
% ax2 = nexttile;
% xlabel('Envergadura (m)'); ylabel('Rotación (rad)');
% title(ax2,'Rotación por torsión perfil abierto');
% plot(ax2,x_nodes_biga(:,1),uopen(3:3:end),'red')
% grid(ax2,'on');
